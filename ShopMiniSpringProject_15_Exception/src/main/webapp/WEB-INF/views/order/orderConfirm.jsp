...
<script>
	function sameAddress(n) {
		...
		if (n.checked) {
			...
			document.getElementById("sample4_postcode").value = document
					.getElementById("mpost1").value;
			document.getElementById("sample4_roadAddress").value = document
					.getElementById("maddress1").value;
			document.getElementById("sample4_jibunAddress").value = document
...
<form name="myForm" method="get" action="loginCheck/orderDone">
	<input type="hidden" name="gCode" value="${cDTO.gCode}"> <input
		type="hidden" name="gName" value="${cDTO.gName}"> <input
		type="hidden" name="gPrice" value="${cDTO.gPrice}"> <input
		type="hidden" name="gSize" value="${cDTO.gSize}"> <input
		type="hidden" name="gColor" value="${cDTO.gColor}"> <input
		type="hidden" name="gAmount" value="${cDTO.gAmount}"> <input
		type="hidden" name="gImage" value="${cDTO.gImage}"> <input
		type="hidden" name="orderNum" value="${cDTO.num}">
	<table width="80%" cellspacing="0" cellpadding="0">
				...
				<table width="100%" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td class="td_default" width="300" style='padding-left: 30px'>
							${cDTO.gName } <br> <font size="2" color="#665b5f">[옵션
								: 사이즈(${cDTO.gSize}) , 색상(${cDTO.gColor})] </font>
						</td>
			...
			<td>
				<table width="100%" cellspacing="0" cellpadding="0" border="1"
					...
					<tr>
						...
						<td height="35" class="td_default"><input
							class="input_default" type="text" id="mpost" size="4"
		...
		<tr>
			<td class="td_default"><input type="checkbox" name="same"
				class="same"> 배송지가 동일할 경우 선택하세요.</td>
		</tr>
		<!--  배송지 정보 시작-->
		<tr>
			<td height="30">
